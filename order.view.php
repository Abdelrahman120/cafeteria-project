...
<head>
    ...
    <link rel="stylesheet"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link href="https://cdn.datatables.net/v/bs5/dt-2.1.4/date-1.5.3/datatables.min.css" rel="stylesheet">
...
<body>
    <?php if ($_SESSION['login'] === true) {
        ...
        <main class="main-body">
            ...
            <form action="" method="post">
                <div id="order_table" class="container table-responsive">
                    ...
                    $records = $db->prepare("SELECT * FROM Orders WHERE `user_id` = :user_id");
                    ...
                    $selectQuery = "SELECT * FROM Orders LIMIT {$start}, {$rowsPerPage}";
        ...
        <script src="https://cdn.datatables.net/v/bs5/dt-2.1.4/date-1.5.3/datatables.min.js"></script>
